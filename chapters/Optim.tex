...
Mathematically this equal to finding a minimum of a loss function which has been introduced in \refsec{lossfunctions}.
...
\refsec{perceptron} already stated, that the perceptron is equal to a linear classifier.
