...
%even though these approaches claim to be close to artists, they are in fact not that close.
...
\todo{parallel brushstrokes instead of sequential ones}

\todo{its not possible to render brushstrokes freely, thus rendering layerout and padding necessary}
...
%place many strokes in one position
...
%superpixel give free distribution
...
\marginnote{Kullback-Leibler (KL) divergence }
