...
For higher orders the displayed process can be applied iteratively and allow for
...
\labsubsubsec{preparation}
%Limit to [-1, 1]
%constraints for neding
%constraints for thickness
%constraints for distance to edge
